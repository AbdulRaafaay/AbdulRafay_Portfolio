      ...
      <div className="mb-10">
        ...
        <ul className="flex flex-wrap gap-3 text-slate-300">
          {skills.technical.map((skill, idx) => (
            <li key={idx} className="bg-slate-800 px-4 py-2 rounded-md text-sm shadow hover:shadow-indigo-500/20 transition">{skill}</li>
          ))}
        </ul>
      </div>
      ...
      <div className="mb-10">
        ...
        <ul className="flex flex-wrap gap-3 text-slate-300">
          {skills.tools.map((tool, idx) => (
            <li key={idx} className="bg-slate-800 px-4 py-2 rounded-md text-sm shadow hover:shadow-indigo-500/20 transition">{tool}</li>
          ))}
        </ul>
      </div>
      ...
      <div>
        ...
        <ul className="flex flex-wrap gap-3 text-slate-300">
          {skills.soft.map((s, idx) => (
            <li key={idx} className="bg-slate-800 px-4 py-2 rounded-md text-sm shadow hover:shadow-indigo-500/20 transition">{s}</li>
          ))}
        </ul>
      </div>
    </section>
